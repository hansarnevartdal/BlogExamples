using System;
using Airline.IdentityServer.Repositories.Configuration;
...
namespace Airline.IdentityServer.Repositories
{
    ...
    {
        Configuration.Configuration _global = new Configuration.Configuration();
        ...
        public Thinktecture.IdentityServer.Models.Configuration.DiagnosticsConfiguration Diagnostics
        {
            get
            {
                return _diag;
